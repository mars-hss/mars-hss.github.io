...
{% include figure.html url="true" img="images/imdl/imdl2_bldc_diagram.avif" caption="[Microchip](https://microchip.my.site.com/s/article/Commutation-Logic-for-Brushless-DC--BLDC--Motor-Control)" width="95%" %}
